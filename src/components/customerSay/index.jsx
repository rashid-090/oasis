  ...
  return (
    <section className='py-10 lg:py-20'>
        <div className='w-11/12 md:w-10/12 mx-auto grid grid-cols-1 gap-10 xl:grid-cols-5'>
            <div className='md:col-span-2 text-center xl:text-left mx-auto text-2xl lg:text-5xl font-bold text-primary flex items-center'><h1>What<br className='hidden xl:block'/> Customers<br className='hidden xl:block'/> Are Saying...</h1></div>
            <div className='md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-5'>
                ...
                <div className='flex flex-col gap-2 p-5 shadow-4xl lg:m-5'>
                    <span className='flex gap-1 text-yellow-400'>
                        <MdOutlineStarPurple500 className='text-3xl'/>
                        <MdOutlineStarPurple500 className='text-3xl'/>
                        <MdOutlineStarPurple500 className='text-3xl'/>
