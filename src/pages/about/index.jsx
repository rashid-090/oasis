...
const AboutUs = () => {
  return (
    <main>
        <div className='bg-abtabg w-full bg-cover bg-center aspect-auto lg:aspect-[20/7]'>
            ...
            <Link to={'/contact-us'} className='bg-primary hover:bg-white hover:text-primary duration-150 uppercase text-base font-medium mt-3 px-10 w-fit py-3 rounded-xl'>contact us</Link>
            </div>
        </div>
        {/*  */}
