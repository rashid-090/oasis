  ...
  return (
    <main>
        <div className='bg-ctabg w-full bg-cover bg-center aspect-auto lg:aspect-[20/7]'>
                ...
                <p className='text-sm md:text-base xl:text-lg 2xl:text-xl uppercase font-medium text-gray-200'>Ready to upgrade your cooling system?<br className='hidden xl:block'/> Look no further! Get in touch with Oasis Cool & Heat Coils LLC for top-notch condenser coils.<br className='hidden xl:block'/> Drop us an email at <a href="mailto:sales@oasisaccoils.com" target='_blank' className='hover:underline'>sales@oasisaccoils.com</a> or ring us up at <a href="tel:+97167313579" target='_blank' className='hover:underline'>+97167313579</a> to get started!</p>
                </div>
        </div>
        {/* form */}
